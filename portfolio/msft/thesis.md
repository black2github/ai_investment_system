# Microsoft Corporation (MSFT, NASDAQ): фактическая позиция
...
**Текущий вектор состояний (снимок LLM на 2026-09-21):** Cloud_AI_Demand=A4 + Software_Monetization=S1 + AI_Capital_Intensity=C3 + Cloud_Margin=M3 + Contracted_Demand=R3.
