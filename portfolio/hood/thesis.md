# Robinhood Markets, Inc. (HOOD, NASDAQ): фактическая позиция
...
**Текущий вектор состояний (снимок LLM на 2026-09-21):** Customer_Asset_Scale=S3 + Revenue_Diversification=R3 + Profitability=P3 + Credit_Risk=C1 + Regulatory_Product=G2.
