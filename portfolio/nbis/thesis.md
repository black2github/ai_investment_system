# Nebius Group N.V. (NBIS, NASDAQ): фактическая позиция
...
**Текущий вектор состояний (снимок LLM на 2026-09-21):** Demand_Monetization=N3 + Unit_Economics=E3 + Capacity_Secured=C3 + Capital_Intensity=K3 + Funding_Liquidity=F2.
