...
Порядок: если приёмка партии 5 (заказ CRWV v1.0.1) ещё не отправлялась — сначала её, потом это сообщение.
...
2.4 **CRWV v1.0.1** — если ещё не выпущен (заказ в приёмке партии 5: ×0.85 к трём вкладам на capex_revenue_nodes.Y2).
