# ASML Holding N.V. (ASML, NASDAQ): фактическая позиция
...
**Текущий вектор состояний (снимок LLM на 2026-09-21):** Demand_Visibility=D3 + EUV_Adoption=E3 + Margin_Execution=M3 + China_Export_Exposure=X1 + Installed_Base_Resilience=I3.
